import { View, Text, ScrollView, Dimensions, TextInput, Pressable, Image, TouchableWithoutFeedback, KeyboardAvoidingView, Keyboard, Platform, TouchableOpacity } from "react-native"
...
import { createFreelancerGig } from "@/service/freelancerService"
import GigPreviewModal from "@/components/preview"
          ...
          <View className="w-[90%] h-[90%] justify-center">
            ...
            <View>
...

             {
              ...
              <Pressable onPress={createGig} disabled={gigLoader} className="w-full items-center bg-[#1E40AF] p-3 rounded-md mb-4 mt-4">
                    {gigLoader ? (
                      <ActivityIndicator size="small" color="white" />
                      ) : (
                        <Text className="text-white font-semibold">Create Gig</Text>
                      )}
              </Pressable>

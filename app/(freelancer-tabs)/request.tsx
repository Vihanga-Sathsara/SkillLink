...
import { getRequestCountForFreelancer } from "@/service/requestService"
...
export default function Request() {
  ...
  React.useEffect(() => {
    ...
    const getRequestCount = async () => {
      try {
        const count = await getRequestCountForFreelancer(auth.currentUser!.uid)
        console.log("Requests for freelancer: ", count)
